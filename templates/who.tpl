...
<apply template="_base">
  ...
  <h3 class="curator"><img src="/static/img/dbp.jpg"/> Daniel Patterson <span>is a PhD student in the Computer Science department and part of the Organizing Committee with GENU-UAW. He thinks Northeastern grads deserve to be treated better than they are, and that a union is the best way to deal with abusive PIs, win better healthcare for dependents, better childcare options, summer funding for all grads, and more flexible visa options for international students. </h3>
